@extends('login.kasir.layout')

@section('title', 'Pesanan Belum Diproses')
@section('header', 'Pesanan Belum Diproses')

@section('filters')
  {{-- Form pencarian dan pengurutan --}}
  <form method="GET" action="{{ route('kasir.pesanan-belum') }}" class="space-y-2">
    {{-- Input Pencarian --}}
    <input
      type="search"
      name="search"
