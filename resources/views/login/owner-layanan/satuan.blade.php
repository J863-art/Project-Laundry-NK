...
<div class="w-full max-w-md rounded-md overflow-hidden shadow-sm border border-gray-200">
    ...
    <div class="relative">
        <img
            src="https://storage.googleapis.com/a1aa/image/b4c2225d-10f8-4dd4-376b-57fa20cb51a5.jpg"
            alt="Hands holding blue clothes inside a front-loading washing machine"
    ...
    <main class="p-5 space-y-3 bg-white">
        <ul class="space-y-3">
            ...
            @empty
                <li class="text-center text-gray-500 italic">Belum ada layanan satuan.</li>
            @endforelse
        </ul>
